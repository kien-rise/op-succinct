...
pub struct ProposerConfig {
    ...
    /// The max number of precaching tasks to run concurrently.
    pub max_concurrent_precaching_tasks: u64,
    ...
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            max_concurrent_defense_tasks: env::var("MAX_CONCURRENT_DEFENSE_TASKS")
                ...
                .parse()?,
            max_concurrent_precaching_tasks: env::var("MAX_CONCURRENT_PRECACHING_TASKS")
                .unwrap_or("8".to_string())
                .parse()?,
